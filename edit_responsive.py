...
new_grid = '''<div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-start">
                    ...
                    <div className="lg:col-span-4 flex flex-col gap-4">
                        <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm w-full overflow-x-auto">
                            <h3 className="text-xs font-bold text-slate-500 mb-3 uppercase tracking-wider">معاينة مباشرة لشكل ورقة الطباعة</h3>
                            <div className="scale-[0.5] sm:scale-[0.6] lg:scale-[0.65] xl:scale-[0.8] origin-top-right w-[210mm] max-w-none">
