  ...
  return (
    <AppLayout title="نقطة البيع">
      <div className="flex flex-row gap-6 items-start flex-1 min-h-0" style={{ direction: 'rtl' }}>
        ...
        {/* ── LEFT: TABLE ────────────────────────────────────────── */}
        <div style={{ flex: 1, background:'white', borderRadius:'24px', padding:'28px', border:'1px solid #f1f5f9', display:'flex', flexDirection:'column', height:'90vh', boxShadow:'0 4px 6px -1px rgba(0,0,0,0.05)' }}>
